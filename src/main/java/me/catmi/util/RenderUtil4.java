...
public class RenderUtil4 {
    ...
    public static void drawImage(ResourceLocation loc, int x, int y, int textureX, int textureY, int width, int height) {
        Wrapper.getMinecraft().renderEngine.bindTexture(loc);
        Wrapper.getMinecraft().ingameGUI.drawTexturedModalRect(x, y, textureX, textureY, width, height);
    ...
    public static void drawESPOutline(AxisAlignedBB bb, float red, float green, float blue, float alpha, float width) {
        ...
        RenderUtil4.drawOutlinedBox(bb);
        GL11.glDisable(2848);
        GL11.glEnable(3553);
        GL11.glEnable(2929);
    ...
    public static boolean isInViewFrustrum(AxisAlignedBB bb) {
        Entity current = Wrapper.getMinecraft().getRenderViewEntity();
