...
public class OGCFONT extends CFont {
    ...
    public OGCFONT(Font font, boolean antiAlias, boolean fractionalMetrics) {
    ...
    public void updateResolution() {
        this.scaledWidth = Wrapper.getMinecraft().displayWidth;
        this.scaledHeight = Wrapper.getMinecraft().displayHeight;
        this.scaleFactor = 1;
        boolean flag = Wrapper.getMinecraft().isUnicode();
        int i = Wrapper.getMinecraft().gameSettings.guiScale;
        if (i == 0)
            i = 1000;
