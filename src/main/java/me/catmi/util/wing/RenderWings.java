...
public class RenderWings extends ModelBase
{
    ...
    public RenderWings(WingSettings settings)
    {
        ...
        this.location = new ResourceLocation( "wings.png");
    ...
    public void onRenderPlayer(RenderPlayerEvent.Post event)
    {
        ...
        if (settings.enabled && player.equals(mc.player) && !player.isInvisible()) // Should render wings onto this player?
        {
            renderWings(player, event.getPartialRenderTick());
        }
    }
