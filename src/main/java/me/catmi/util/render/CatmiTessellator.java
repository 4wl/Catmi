...
public class CatmiTessellator extends Tessellator{

	public static CatmiTessellator INSTANCE = new CatmiTessellator();

	public CatmiTessellator(){
		super(0x200000);
	}
	...
	public static void drawBox(AxisAlignedBB bb, CMColor color, int sides) {
		drawBox(INSTANCE.getBuffer(), bb, color, sides);
	}
	
	public static void drawBox(BlockPos blockPos, CMColor color, int sides) {
		drawBox(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1, 1, 1, color, sides);
	}
	
	public static void drawBox(BufferBuilder buffer, AxisAlignedBB bb, CMColor color, int sides) {
	...
	public static void drawDownBox(BlockPos blockPos, CMColor color, int sides) {
		drawDownBox(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1, 1, 1, color, sides);
	}

	public static void drawDownBox (BufferBuilder buffer, float x, float y, float z, float w, float h, float d, CMColor color, int sides) {
		drawBox(buffer,x,y,z,w,-h,d,color,sides);
	}

	public static void drawBox(BufferBuilder buffer, float x, float y, float z, float w, float h, float d, CMColor color, int sides) {
	...
	public static void drawBoundingBox(final AxisAlignedBB bb, final float width, CMColor color) {
	...
	public static void drawBoundingBoxBlockPos(BlockPos bp, float width, CMColor color) {
	...
	public static void drawBoundingBoxBlockPos2(BlockPos bp, float width, CMColor color) {
		int r=color.getRed(), g=color.getGreen(), b=color.getBlue(), alpha=color.getAlpha();
		GlStateManager.pushMatrix();
		GlStateManager.enableBlend();
		GlStateManager.disableDepth();
	...
	public static void drawBoundingBoxBottom2(BlockPos bp, float width, CMColor color) {
		int red=color.getRed(), green=color.getGreen(), blue=color.getBlue(), alpha=color.getAlpha();
		GlStateManager.pushMatrix();
		GlStateManager.enableBlend();
		GlStateManager.disableDepth();
