...
import static me.catmi.util.world.BlockUtils.canBeClicked;
import static me.catmi.util.world.BlockUtils.faceVectorPacketInstant;
...
public class AutoFeetPlace extends Module {
	...
	public void onUpdate(){
		...
		while (blocksPlaced <= blocksPerTick.getValue()){
			Vec3d[] offsetPattern;
			offsetPattern = AutoFeetPlace.Offsets.SURROUND;
			int maxSteps = AutoFeetPlace.Offsets.SURROUND.length;
