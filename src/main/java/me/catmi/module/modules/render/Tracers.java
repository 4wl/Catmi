...
public class Tracers extends Module {
	...
	public void setup(){
		...
		nearColor=registerColor("Near Color","NearColor",new CMColor(255,0,0));
		midColor=registerColor("Middle Color","MidColor",new CMColor(255,255,0));
		farColor=registerColor("Far Color","FarColor",new CMColor(0,255,0));
	}
	...
	public void drawLineToEntityPlayer(Entity e, CMColor color){
	...
	public void drawLine1(double posx, double posy, double posz, double up, CMColor color){
	...
	public static void renderLine(double posx, double posy, double posz, double posx2, double posy2, double posz2, double up, CMColor color){
		GL11.glPushMatrix();
	...
	public static void renderLine(double posx, double posy, double posz, double posx2, double posy2, double posz2, CMColor color){
