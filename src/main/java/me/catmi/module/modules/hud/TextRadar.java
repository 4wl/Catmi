				...
				.forEach(e->{
					...
					if (sortUp.getValue()){
						if (sortRight.getValue()){
								FontUtils.drawStringWithShadow(HUD.customFont.getValue(), TextFormatting.GRAY + " Cat Health " + healthcolor + (int) (((EntityPlayer) e).getHealth() + ((EntityPlayer) e).getAbsorptionAmount()) + TextFormatting.GRAY + " " + friendcolor + e.getName() + TextFormatting.GRAY + " [" + distancecolor + (int) mc.player.getDistance(e) + TextFormatting.GRAY + "]", radarX.getValue() - FontUtils.getStringWidth(HUD.customFont.getValue(), TextFormatting.GRAY + "[" + healthcolor + (int) (((EntityPlayer) e).getHealth() + ((EntityPlayer) e).getAbsorptionAmount()) + TextFormatting.GRAY + "] " + friendcolor + e.getName() + TextFormatting.GRAY + " [" + distancecolor + (int) mc.player.getDistance(e) + TextFormatting.GRAY + "is ur friend]"), radarY.getValue() + (playerCount * 10), new CMColor(255,255,255));
						} else {
								FontUtils.drawStringWithShadow(HUD.customFont.getValue(), TextFormatting.GRAY + " Cat Health " + healthcolor + (int) (((EntityPlayer) e).getHealth() + ((EntityPlayer) e).getAbsorptionAmount()) + TextFormatting.GRAY + " " + friendcolor + e.getName() + TextFormatting.GRAY + " [" + distancecolor + (int) mc.player.getDistance(e) + TextFormatting.GRAY + "]", radarX.getValue(), radarY.getValue() + (playerCount * 10), new CMColor(255,255,255));
						}
						playerCount++;
					}
					else {
						if (sortRight.getValue()){
							FontUtils.drawStringWithShadow(HUD.customFont.getValue(), TextFormatting.GRAY + " Cat Health " + healthcolor + (int)(((EntityPlayer) e).getHealth() + ((EntityPlayer) e).getAbsorptionAmount()) + TextFormatting.GRAY + " " + friendcolor + e.getName() + TextFormatting.GRAY + " [" + distancecolor + (int)mc.player.getDistance(e) + TextFormatting.GRAY + "]", radarX.getValue() - FontUtils.getStringWidth(HUD.customFont.getValue(), TextFormatting.GRAY + "[" + healthcolor + (int)(((EntityPlayer) e).getHealth() + ((EntityPlayer) e).getAbsorptionAmount()) + TextFormatting.GRAY + "] " + friendcolor + e.getName() + TextFormatting.GRAY + " [" + distancecolor + (int)mc.player.getDistance(e) + TextFormatting.GRAY + "is not ur friend]"), radarY.getValue() + (playerCount * -10), new CMColor(255,255,255));
						} else {
							FontUtils.drawStringWithShadow(HUD.customFont.getValue(), TextFormatting.GRAY + " Cat Health " + healthcolor + (int)(((EntityPlayer) e).getHealth() + ((EntityPlayer) e).getAbsorptionAmount()) + TextFormatting.GRAY + " " + friendcolor + e.getName() + TextFormatting.GRAY + " [" + distancecolor + (int)mc.player.getDistance(e) + TextFormatting.GRAY + "]", radarX.getValue(), radarY.getValue() + (playerCount * -10), new CMColor(255,255,255));
						}
						playerCount++;
