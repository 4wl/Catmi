...
public class ColorMain extends Module{
	...
	public static CMColor getFriendGSColor(){
		return new CMColor(settingToColor(friendcolor));
	}

	public static CMColor getEnemyGSColor(){
		return new CMColor(settingToColor(enemycolor));
	}
}