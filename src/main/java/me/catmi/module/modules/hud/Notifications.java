		...
		for (TextComponentString s : list){
			...
			if (sortUp.getValue()){
				if (sortRight.getValue()){
					FontUtils.drawStringWithShadow(HUD.customFont.getValue(),s.getText(), notX.getValue() - FontUtils.getStringWidth(HUD.customFont.getValue(),s.getText()), notY.getValue() + (notCount * 10), new CMColor(255,255,255));
				}
				else {
					FontUtils.drawStringWithShadow(HUD.customFont.getValue(),s.getText(), notX.getValue(),notY.getValue() + (notCount * 10), new CMColor(255,255,255));
				}
			}
			else {
				if (sortRight.getValue()){
