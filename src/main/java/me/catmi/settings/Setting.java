...
public abstract class Setting {
	...
	public static class ColorSetting extends Setting {
		...
		private CMColor value;
		
		public ColorSetting (final String name, final String configname, final Module parent, final Module.Category category, boolean rainbow, final CMColor value) {
			super(name,configname,parent,category,Type.COLOR);
			this.rainbow=rainbow;
			this.value=value;
		}
		
		public CMColor getValue() {
			if (rainbow) {
				return CMColor.fromHSB((System.currentTimeMillis()%(360*32))/(360f * 32),1,1);
			} return value;
		}
		
		public void setValue (boolean rainbow, final CMColor value) {
			this.rainbow=rainbow;
			this.value=value;
		}
		...
		public void fromInteger (int number) {
			value=new CMColor(number&0xFFFFFF);
			rainbow=((number&0x1000000)!=0);
		}
		
		public CMColor getColor() {
			return value;
		}
    ...
    public static class Builder {
		...
		public Object setName(String speed) {
